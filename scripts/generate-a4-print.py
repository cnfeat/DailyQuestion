...
<style>
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  .cp-title{font-size:22pt;font-weight:700;letter-spacing:8px;margin-bottom:4mm}
  .cp-sub{font-size:7pt;font-weight:300;letter-spacing:6px;opacity:.65;margin-bottom:10mm}
  .cp-line{width:30mm;height:.5px;background:rgba(255,255,255,.2);margin-bottom:10mm}
  .cp-count{font-size:9pt;letter-spacing:3px;margin-bottom:2mm}
  .cp-domains{font-size:5pt;opacity:.4;letter-spacing:1.5px;max-width:120mm;text-align:center;line-height:1.8}
...
def generate():
    ...
    # 封面页
    cover_html = '<div class="page cover-page" style="position:relative">'
